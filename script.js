    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הובלות move on משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: 'f047a70a-a047-4b95-a343-70504c5818a5',
                        name: data.name,
                        email: data.email,
